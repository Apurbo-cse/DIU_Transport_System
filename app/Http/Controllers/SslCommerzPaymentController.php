...
class SslCommerzPaymentController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $seat='';
        foreach ($request->seat_no as $value){
            $seat .=  $value.',';
        }
        $post_data = array();
        ...
        $post_data['date'] = date('Y-m-d', strtotime(str_replace('-', '/', $request->date)));
        ...
        $update_product = DB::table('orders')
            ...
            ->updateOrInsert([
                ...
                'route_id' => $post_data['route_id'],
                'bus_id' => $post_data['bus_id'],
                'departure_time' => $post_data['departure_time'],
                'date' => $post_data['date'],
                'seat_no' => $post_data['seat_no'],
    ...
    {
        $data['transaction_message'] = 'Transaction successfully Completed';
        $data['type'] = 'success';
